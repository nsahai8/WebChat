...
public class AppController {
	...
	public ModelAndView createUser(@RequestParam(value = "email") String email,
	...
	public void sendMessege(@RequestParam(value = "message") String message,
			@RequestParam(value = "sender") String sender, @RequestParam(value = "receiver") String receiver) {
	...
	// get Messaged comunicated between two users
	...
	// create group of users
	@RequestMapping(value = "/createGroupChat", method = RequestMethod.GET)
	public String createGroupChat(@RequestParam(value="groupName")String groupName,@RequestParam(value="members")List<String> members) {
		GroupChat groupChat = new GroupChat();
		groupChat.setGroupCreated(new Date());
		groupChat.setGroupName(groupName);
		List<User> groupMembers = new ArrayList<User>();
		for(String userName:members){
			groupMembers.add(appService.getUserByEmailId(userName));
		}
		groupChat.setGroupMembers(groupMembers);
		groupChat.setStatus(ai.niki.model.GroupChat.MessageStatus.NotSeenByAll);
		groupChatService.save(groupChat);
	...
	//get All groups whose member he is
	...
	//get Messages of group by group Name
